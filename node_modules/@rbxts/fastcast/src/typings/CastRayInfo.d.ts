 ...
 */
declare interface CastRayInfo<T extends Instance> {
    //Properties
     ...
     */
    CosmeticBulletObject?: T

    /**
     * A reference to the input pierce function from the parent Caster's Fire method. See Caster for more information.
     */
    CanPierceCallback: (cast: ActiveCast<T>, result: RaycastResult, segmentVelocity: Vector3) => boolean
}
