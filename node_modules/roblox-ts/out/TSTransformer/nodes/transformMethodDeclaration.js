...
function transformMethodDeclaration(state, node, ptr) {
    ...
    luau_ast_1.default.list.pushList(statements, (0, transformStatementList_1.transformStatementList)(state, node.body.statements));
    let name = (0, transformPropertyName_1.transformPropertyName)(state, node.name);
    if (node.decorators !== undefined && !luau_ast_1.default.isSimple(name)) {
