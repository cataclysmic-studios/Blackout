...
function transformClassConstructor(state, node, name, originNode) {
        ...
        if (!removeFirstSuper) {
            ...
            if (bodyStatements.length > 0) {
                ...
                if (typescript_1.default.isExpressionStatement(firstStatement) && typescript_1.default.isSuperCall(firstStatement.expression)) {
                    luau_ast_1.default.list.pushList(statements, (0, transformStatementList_1.transformStatementList)(state, [firstStatement]));
                }
            }
        }
    }
    ...
    luau_ast_1.default.list.pushList(statements, (0, transformStatementList_1.transformStatementList)(state, bodyStatements));
