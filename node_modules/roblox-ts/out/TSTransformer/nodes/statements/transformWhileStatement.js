...
function transformWhileStatement(state, node) {
    ...
    luau_ast_1.default.list.pushList(whileStatements, (0, transformStatementList_1.transformStatementList)(state, (0, getStatements_1.getStatements)(node.statement)));
