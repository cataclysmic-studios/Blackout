...
function transformIfStatementInner(state, node) {
    ...
    const statements = (0, transformStatementList_1.transformStatementList)(state, (0, getStatements_1.getStatements)(node.thenStatement));
    ...
    if (elseStatement === undefined) {
        ...
        elseBody = (0, transformStatementList_1.transformStatementList)(state, (0, getStatements_1.getStatements)(elseStatement));
    }
