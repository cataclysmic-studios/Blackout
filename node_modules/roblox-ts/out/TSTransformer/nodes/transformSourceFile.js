...
function transformSourceFile(state, node) {
    ...
    if (state.usesRuntimeLib) {
        luau_ast_1.default.list.unshift(statements, state.createRuntimeLibImport(node));
    }
    luau_ast_1.default.list.unshift(statements, luau_ast_1.default.comment(`Compiled with roblox-ts v${constants_1.COMPILER_VERSION}`));
    return statements;
}
