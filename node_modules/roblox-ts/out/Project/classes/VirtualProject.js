...
class VirtualProject {
    ...
    compileSource(source) {
        ...
        const transformState = new TSTransformer_1.TransformState(this.program, this.data, services, pathTranslator, multiTransformState, this.compilerOptions, this.rojoResolver, this.pkgRojoResolvers, this.nodeModulesPathMapping, new Map(), runtimeLibRbxPath, this.typeChecker, projectType, sourceFile);
