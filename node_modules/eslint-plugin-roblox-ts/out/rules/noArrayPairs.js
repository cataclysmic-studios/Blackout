...
exports.noArrayPairs = rules_1.makeRule({
        ...
        return {
            CallExpression(esNode) {
                ...
                if (expressionName === "pairs" || expressionName === "ipairs") {
                    const argType = types_1.getType(checker, tsNode.arguments[0]);
                    if (types_1.isPossiblyType(argType, t => types_1.isArrayType(checker, t))) {
