...
exports.EnvCallAsStringMacro = exports.isUnsafeToPrint = exports.getEnvDefaultValue = void 0;
...
function isUnsafeToPrint(variable) {
    var valueLower = variable.toLowerCase();
    return (valueLower.includes("token") ||
        valueLower.includes("secret") ||
        valueLower.includes("api") ||
        valueLower.includes("key"));
}
exports.isUnsafeToPrint = isUnsafeToPrint;
    ...
    transform: function (state, callExpression) {
        ...
        if (typescript_1.default.isStringLiteral(variableArg)) {
            ...
            if (state.config.verbose) {
                state.logger.infoIfVerbose("Transform variable ".concat(variableName, " to ").concat(isUnsafeToPrint(variableName)
                    ? "***"
                    : printer.printNode(typescript_1.default.EmitHint.Expression, expression, callExpression.getSourceFile())));
