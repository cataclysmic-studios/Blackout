...
export const ClientStore = new Rodux.Store<ClientStore, StoreActions>(
  StoreReducer,
  {},
  [Rodux.thunkMiddleware] as never
); // `never` is a hacky way to get around Rodux's fiddly type definitions (should be fine)
